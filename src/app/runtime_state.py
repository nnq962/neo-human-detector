...
Class này lưu snapshot mới nhất của WebSocket payload và robot service request.
...
class RuntimeState:
    ...
    Sau này WebSocket server hoặc robot sender có thể đọc snapshot từ đây mà không
